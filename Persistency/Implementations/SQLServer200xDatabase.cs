...
namespace IndianaPark.Persistence
{
    ...
    /// </summary>
    public class SQLServer200xDatabase : PersistenceFactory
    {
            ...
            try
            {
                if( this.m_connection == null )
                {
                    ...
                    Logger.Default.Write(
                        String.Format( "{0}\n\t{1}", "Create connection to database SQL Server 200x with connection string: ", connectionString ),
        ...
        public override string GetConnectionString( string host, string user, string password, string schema )
        {
            ...
            return String.Format(
                @"Data Source={0};Initial Catalog={3};Persist Security Info=True;User ID={1};Password={2};Pooling=False",
