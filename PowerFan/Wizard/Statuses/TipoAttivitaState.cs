...
{
    /// <summary>
    /// Rappresenta lo stato in cui si sceglie il tipo di attrazione per cui fare il biglietto
    /// </summary>
    public class TipoAttivitaState : PowerfanBaseState
    {
        private Model.Biglietto m_biglietto;

        /// <summary>
        /// Initializes a new instance of the <see cref="TipoAttivitaState"/> class.
        /// </summary>
        ...
        /// </remarks>
        public TipoAttivitaState( Tools.Wizard.Wizard wizard, IState previous ) : base( wizard, previous )
        {
        }
        ...
        {
            this.StateForm = new Forms.New.TipoAttivitaForm();
        ...
        {
            if( this.m_biglietto != null )
            {
                builder.Storage.TipoBiglietto = this.m_biglietto.GetType();
            }
        }
        ...
        {
            this.m_biglietto = WizardForm.ConvertUserData<Model.Biglietto>( (Forms.New.TipoAttivitaForm)source );

            this.NextState = this.StatePool.GetUniqueType( new QuantityState( this.Wizard, this ) );
