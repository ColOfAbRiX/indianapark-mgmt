...
namespace IndianaPark.Biglietti.Wizard
{
    ...
    /// di dati con l'utente <see cref="this.UserData"/> e una per la GUI visualizzata all'utente <see cref="StateForm"/>.</para>
    ...
    /// </remarks>
    public abstract class EmissioneBaseState<TBuilder> : WizardStateBase where TBuilder : IBuilder
    {
		#region Fields 
        ...
        /// </remarks>
        protected TypedObjectPool<EmissioneBaseState<TBuilder>> StatePool { get; private set; }
        /// <summary>
        /// Form gestita dallo stato
        /// </summary>
        protected System.Windows.Forms.Form Gui { get; set; }
        ...
        /// </remarks>
        protected EmissioneBaseState( Tools.Wizard.Wizard wizard, IState previous ) : base( wizard, previous )
        {
            this.StatePool = new IndianaPark.Tools.TypedObjectPool<EmissioneBaseState<TBuilder>>();
        }
