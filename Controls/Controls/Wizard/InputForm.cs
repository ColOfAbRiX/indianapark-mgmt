...
namespace IndianaPark.Tools.Controls
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>Ogni implementazione di questa classe astratta deve implementare i metodi per controllare la validità dei
    /// dati e per gestire cosa fare quando l'utente chiede di proseguire con i dati errati.</para>
    /// <para>Implementa il pattern Template Method</para>
    /// </remarks>
    public abstract partial class InputForm : WizardForm
    {
        ...
        /// </remarks>
        public override bool IsDataValid { get; protected set; }
        ...
        /// <summary>
        /// Gestisce le richieste di <see cref="NavigationAction.Back"/> exception <see cref="NavigationAction.Cancel"/>
        ...
        /// <remarks>
        /// Ogni volta che l'utente cambia il testo inserito questo metodo ne controlla la validità exception aggiorna la
